...
再次是协同规则约束。无人机的起飞和降落地点仅限于仓库或顾客位置。无人机和卡车只能够在顾客节点会合，不能在行驶过程中进行会合，在实际应用中，由于无人机降落在行驶过程中的卡车需要卡车和无人机的速度相匹配，而这个匹配的过程十分困难\cite{buchmueller2016landing}，并且无人机降低速度匹配卡车会降低无人机的配送效率，因此这里假设无人机和卡车只能在顾客节点会合。当卡车和无人机在某一节点会合时，如果卡车先到达，需等待无人机，若无人机先到达，则无人机等待卡车，但是无人机的等待时间不能超过无人机剩下的续航时间。
...
\begin{align}
	...
	\quad & \sum_{i \in V_2}\sum_{k \in V_2} q_j x_{ijks}^D \leq Q^D, \quad \forall j \in N, s \in S \label{eq:conv-level-2-drone-weight}\\
    ...
    \quad & u_0^L = 0 \label{eq:conv-auxiliary-initial-2}\\
    % \quad & \tau_{ss}^T = \tau_{ss}^D = \rho_{ss} = 0, \quad \forall s \in S \label{eq:conv-auxiliary-initial-3}\\
