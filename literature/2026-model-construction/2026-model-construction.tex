...
% TODO: 如果出现无人机的环的问题，则可以把时间相关的约束加回来
\begin{theorem}
{
\begin{align}
    ...
    \quad & u_j^L \geq u_i^L + \psi_{j} - M\left(1 - x_{ij}^L\right), \quad \forall i \in V_1, \forall j \in S, i \neq j \label{eq:conv-level-1-subtour}\\
