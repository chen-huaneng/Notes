...
% huanengchen@foxmail.com 2026-05-28
%===================================
...
\crefname{table}{表}{表} % 设置非首字母大写的表引用格式
\Crefname{table}{表}{表} % 设置首字母大写的表引用格式
\crefname{figure}{图}{图} % 设置非首字母大写的图引用格式
\Crefname{figure}{图}{图} % 设置首字母大写的图引用格式
\AtBeginDocument{\renewcommand{\crefpairconjunction}{-}} % 引用两个公式时用"-"代替"and"
